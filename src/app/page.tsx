...
export default function HomePage() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <section className="bg-luxury-obsidian-deep py-16 border-b border-luxury-obsidian-border relative z-10">
      ...
      <section className="bg-luxury-obsidian-deep border-t border-luxury-obsidian-border py-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center space-y-8">
          ...
          <div className="flex items-center justify-center space-x-4 pt-4">
            <button
              onClick={prevReview}
              className="p-2 border border-white/10 hover:border-luxury-gold rounded text-luxury-silver hover:text-luxury-gold transition-colors duration-300"
