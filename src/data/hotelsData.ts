...
export const translations = {
  en: {
    ...
    timeSlot: "Time Slot",
    dayOutTimeSlot: "11:00 AM – 5:00 PM",
  ...
  si: {
    ...
    bookingTypeLabel: "වෙන්කිරීමේ වර්ගය",
    nightStay: "රාත්‍රී නවාතැන",
    dayOut: "දිවා විනෝදය",
    visitDate: "පැමිණෙන දිනය",
    timeSlot: "කාල සීමාව",
    dayOutTimeSlot: "පෙ.ව. 11:00 – ප.ව. 5:00",
    ...
    facilitiesList: {
      ...
      "Attached Bathroom": "ඇමුණුම් නාන කාමරය",
      "Hot Water": "උණු වතුර",
  ...
  ta: {
    ...
    bookingTypeLabel: "பதிவு வகை",
    nightStay: "இரவு தங்குமிடம்",
    dayOut: "பகல் வருகை",
    visitDate: "வருகை தேதி",
    timeSlot: "நேர இடைவெளி",
    dayOutTimeSlot: "காலை 11:00 – மாலை 5:00",
